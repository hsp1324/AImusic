...
def learning(x, a0, parameters, times):
    for i in range(times):
        ...
        parameters["Wf"] = parameters["Wf"] - gradients["dWf"]*0.1
        parameters["bf"] = parameters["bf"] - gradients["dbf"]*0.1
        parameters["Wi"] = parameters["Wi"] - gradients["dWi"]*0.1
        parameters["bi"] = parameters["bi"] - gradients["dbi"]*0.1
        parameters["Wo"] = parameters["Wo"] - gradients["dWo"]*0.1
        parameters["bo"] = parameters["bo"] - gradients["dbo"]*0.1
    return a, y, c, caches

a, y, c, caches = learning(x, a0, parameters, 5000)
